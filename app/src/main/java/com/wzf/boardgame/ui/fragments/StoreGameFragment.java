...
import com.wzf.boardgame.ui.views.pullview.MultiColumnListView;
import com.wzf.boardgame.ui.views.pullview.internal.PLA_AdapterView;
...
public class StoreGameFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = bActivity.getLayoutInflater().inflate(R.layout.layout_game_store, null);

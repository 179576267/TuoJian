package com.wzf.tuojian.ui.model;
...
import com.wzf.tuojian.function.http.dto.request.HeaderParams;
import com.wzf.tuojian.function.http.dto.request.UpLbsReqDto;
...
import com.wzf.tuojian.utils.PreferencesHelper;
...
public class UserInfo {
    ...
    public void updateLbs() {
        if(TextUtils.isEmpty(getUid()) || BaiDuMapManager.getInstance().getLat() == BaiDuMapManager.getInstance().getLon() ){
            return;
        }

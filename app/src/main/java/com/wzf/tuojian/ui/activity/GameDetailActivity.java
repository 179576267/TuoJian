...
import com.wzf.tuojian.function.http.dto.request.CommentGameListReqDto;
import com.wzf.tuojian.function.http.dto.request.GameCommentRecommendReqDto;
import com.wzf.tuojian.function.http.dto.request.GameReqDto;
import com.wzf.tuojian.function.http.dto.response.GameCommentListResDto;
import com.wzf.tuojian.function.http.dto.response.GameDetailResDto;
import com.wzf.tuojian.function.imageloader.ImageLoader;
import com.wzf.tuojian.ui.adapter.OnRecyclerScrollListener;
import com.wzf.tuojian.ui.adapter.RcyCommonAdapter;
import com.wzf.tuojian.ui.adapter.RcyViewHolder;
...
public class GameDetailActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void updateTitleBar() {
        ...
        drawable = getResources().getDrawable(headerDto.getIsRule() == 0 ? R.mipmap.gamedata_btn_book_dis : R.mipmap.gamedata_btn_book_nor);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight()); //设置边界
        tvRule.setCompoundDrawables(null, drawable, null, null);//画在右边

        drawable = getResources().getDrawable(headerDto.getIsExtend() == 0 ? R.mipmap.gamedata_btn_extend_dis : R.mipmap.gamedata_btn_extend_nor);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight()); //设置边界

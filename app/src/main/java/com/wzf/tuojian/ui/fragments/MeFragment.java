...
import com.wzf.tuojian.function.http.dto.request.UserInfoReqDto;
import com.wzf.tuojian.function.http.dto.response.UserInfoResDto;
import com.wzf.tuojian.function.imageloader.ImageLoader;
import com.wzf.tuojian.ui.activity.FansActivity;
import com.wzf.tuojian.ui.activity.FollowsActivity;
import com.wzf.tuojian.ui.activity.MeInfoEditActivity;
import com.wzf.tuojian.ui.activity.MessageRemindActivity;
import com.wzf.tuojian.ui.activity.ReplyActivity;
import com.wzf.tuojian.ui.activity.StoreActivity;
import com.wzf.tuojian.ui.activity.SubjectsActivity;
...
//                        responseDto.setIsMsgRemind(1);
                        if(responseDto != null){
                            imMessageRedPoint.setVisibility(responseDto.getIsMsgRemind() == 0? View.GONE : View.VISIBLE);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ll_message:
                imMessageRedPoint.setVisibility(View.GONE);
